...
"color: rgb(255, 255, 255);")
        ...
        self.btnPrint.clicked.connect(lambda:Print_File(self.tableView_GiaoDichHoaDon,self.txtTinhTongDoanhThu, [self.txtTinhTongDoanhThu,self.txtTongLuongNhanVien]))
        self.LichSu()
